...
### مشخصات نسخه‌ی تاکتیکال (پیش‌فرض)
- ابعاد بیرونی: **۷۲ × ۱۱۸ × ۲۸ میلی‌متر** (عرض کم برای دست، عمق کم)
- **۵ سوراخ آنتن SMA** (۳× nRF24 + CC1101 + آنتن اصلی) — قطر سوراخ ۶.۵mm
- پورت‌ها: USB-C (۱۰×۵.۵)، microSD (۱۳×۲.۸)، کلید پاور (۹×۵) — روی لبه‌ها
- **بدون دکمه** (کنترل کاملاً لمسی؛ فریمور تاچ را پشتیبانی می‌کند)
- **پایه‌ی گُوِه‌ای پشت**: وقتی پشتِ دستگاه (که رادار آن‌جاست) را به هدف نشانه می‌گیری،
  دستگاه عقب می‌خوابد و صفحه رو به تو کج می‌شود (`kickstand=true`؛ زاویه با `ks_thick`)
- بزل نازک پله‌ای دور نمایشگر تا صفحه بزرگ‌تر به نظر برسد
